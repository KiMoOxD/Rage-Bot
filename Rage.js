...
client.on('ready', () => {
     client.user.setActivity("Rage | !!help",{type: 'WATCHING'});
...
console.log("Discord Bot By So.?");
  console.log('BySo.?')
      ...
      client.on('guildMemberAdd', member => {
        ...
        .setTitle(`Welcome To Rage Server  :rose: :dove: ,......`)
        .setDescription(`اهلاً بك في سيرفرنا :blush:`)
        .addField(' :bust_in_silhouette: [  انت عضو رقم ]',`**[ ${member.guild.memberCount} ]**`,true)
        .setColor('GREEN')
        .setFooter('♔-----「Rage - Server」-----♔', 'https://cdn.discordapp.com/attachments/397818254439219217/399292026782351381/shy.png')
    
    var channel =member.guild.channels.find('name', 'staffs')
    if (!channel) return;
    ...
    var channel =member.guild.channels.find('name', 'rage')
    if (!channel) return;
    channel.send({embed : embed});
    }) 
...
"https://cdn.discordapp.com/attachments/409474364254191616/416336000961478686/Z.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336054430466049/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336076077006868/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336113377083412/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336154649165856/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336203911004180/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336250883276821/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336722473779220/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336764911878154/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336791776526346/images.png",
"https://cdn.discordapp.com/attachments/409474364254191616/416336984844402690/images.png",
...
client.on("message", message => {
     if (message.content === "!!help") {
         if(!message.channel.guild) return message.reply('** This command only for servers **');
        message.reply("تم الارسال في الخاص")
     }
});
    client.on('message', message => {
     if (message.content === "95id") {
     let embed = new Discord.RichEmbed()
  .setThumbnail(message.author.avatarURL)  
  .setAuthor(message.author.username)
  .setDescription("معلومات عن الحــساب")
  .setFooter(`© MaxDev ™.`, 'https://cdn.discordapp.com/attachments/409474364254191616/416349411569041408/ssseeeqqq.png')
  .setColor("#9B59B6")
...
if(message.content.split(' ')[0] == '856bc') {
        message.guild.members.forEach(m => {
   if(!message.member.hasPermission('ADMINISTRATOR')); 
            var bc = new Discord.RichEmbed()
            .setAuthor(`Rage - Bot`, 'https://cdn.discordapp.com/attachments/409474364254191616/416349411569041408/ssseeeqqq.png')
...
client.on('ready', () => {
   console.log(`----------------`);
      console.log(`Rage Bot- Script By : Max`);
        console.log(`----------------`);
      console.log(`ON ${client.guilds.size} Servers '     Script By : Max ' `);
    console.log(`----------------`)
});
client.on("message", message => {    
          if(!message.channel.guild) return;
...
💎!!id 『لمعرفه معلومات الحساب』

💎!!cat 『صور قطط』

💎!!contact  『ار سال رساله لصاحب البوت 』

💎!!stats 『معلومات عن البوت 』

💎!!time 『لمعرفه الوقت واليوم والتاريخ 』
● ▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬ ● 
...
👑!!mute <user> <Reason>『 اعطاء ميوت كتابي 』

👑!!unmute  『فك ميوت كتابي عن عضو  』

👑!!createcolors   『 انشاء 140 لون 』

👑!!bc  <Message>『ارسال رساله برود كاست للاعضاء』
...
client.users.get("290908670529896448").send(
    "\n" + "**" + "● السيرفر :" + "**" +
    "\n" + "**" + "» " + message.guild.name + "**" +
    "\n" + "**" + " ● المرسل : " + "**" +
    "\n" + "**" + "» " + message.author.tag + "**" +
...
.setDescription([`**Time : **${moment().format('HH:mm:ss A')}
**Date : ** :${moment().format('YYYY/M/D')}       
**Day : **${moment().format('dddd')}`])
message.channel.send(id) //By:Zoroᴰᵉᵛ🔥
};
});
client.on('message', message => {
...
client.on('message', message => {
	...
	client.on('guildMemberAdd', member => {
     ...
     if (member.guild.id === "341035736591761410") {
    
    
var Canvas = require('canvas')
var jimp = require('jimp')

const w = ['./w1.jpg','./w2.jpg','./w3.jpg','./w4.jpg','./w6.jpg','./rb.jpg'];
            ...
            ctx.drawImage(ground, 0, 0, 401, 202);
                ...
                jimp.read(url, (err, ava) => {
                    ...
                    ava.getBuffer(jimp.MIME_PNG, (err, buf) => {
                        ...
                        ctx.fillText("Welcome To Rage Server", 200, 163);
...
client.channels.get("410384470068428800").sendFile(canvas.toBuffer())
client.channels.get("410384470068428800").send(`Welcome ${member} To __Rage Server__`)
...
var chaneel_id = "420880224444612608";
                    var i = "0";
                    var x = "0";
client.on("voiceChannelJoin", (msg) => {
    x++;
    client.editChannel(chaneel_id, { name : "Voice ⇏「" + x + "」"});
});
...
client.on("messageCreate", (msg) => {
    if(msg.author.id !== "290908670529896448") return client.createMessage('__**This Command is only for the bot Owner**__');
      ...
      message.reply( 'Your Balance is ' +  `${row.points}` + '$' + ' :credit_card:');
         ...
         client.on('message', message => {
            if (message.content === 'ترحيب') {
              message.channel.send('** **```Welcome To Rage Server```**  :gem: :rose: :dove:  ,...** ');
